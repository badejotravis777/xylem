...

    {
...

      {
        ...
        price: 300000,
         unit: "per liter",
        category: "Liquids/Oils",
        image: "/assets/Alpha Bisabolol3.png",
...

      {
        ...
        price: 90000,
        unit: "per kg",
        category: "Powder/Enzyme",
        image: "/assets/Nag.png",
        description: "A skin-brightening and barrier-strengthening ingredient that helps reduce hyperpigmentation, evens skin tone, and boosts natural hyaluronic acid production. Gentle and suitable for sensitive skin."
      },

      {
        id: 48,
        name: "C13-C15 alkyl benzoate",
        price: 35000,
        unit: "per kg",
        category: "Powders/Enzyme",
        image: "/assets/C13-C15 alkyl benzoate2.png",
        description: "A lightweight, fast-absorbing emollient that provides a silky, non-greasy finish. Common in sunscreens and lotions for improving texture and spreadability."
      },


      {
        id: 49,
        name: "Ethyloxydiglycol",
        price: 40000,
        unit: "per liter",
        category: "Liquids/Oils",
        image: "/assets/Ethyloxydiglycol2.png",
        description: "A solvent and penetration enhancer that helps active ingredients absorb deeper into the skin. Also improves formula clarity and stability in serums and gels."
      },

      {
        ...
        description: "An antioxidant Vitamin C derivative known for brightening, reducing acne, and supporting collagen production. More stable and less irritating than pure ascorbic acid."
      },

      {
        ...
        description: "A stable, gentle form of Vitamin C that brightens skin, improves uneven tone, and fights free radicals. Ideal for sensitive skin and daytime formulations."
      },

      {
        ...
        unit: "per kg",
        category: "Specialty",
        image: "/assets/Dipotassium glycyrrhizinate.png",
        description: "A soothing anti-inflammatory ingredient derived from licorice root. Helps reduce redness, calm irritation, and support sensitive or acne-prone skin."
      },

      {
        ...
        unit: "per kg",
        category: "Specialty",
        image: "/assets/Ethyl ascorbic acid.png",
        description: "A highly stable and effective Vitamin C derivative that brightens skin, fades dark spots, and boosts collagen. Penetrates well and works across most skin types."
      },
